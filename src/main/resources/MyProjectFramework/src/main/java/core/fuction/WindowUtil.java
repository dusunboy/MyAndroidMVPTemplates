...
public class WindowUtil {
    ...
    public static boolean setWidth(View view, int designedWidthResId) {
        float designedWidth = BaseApp.getAppContext().getResources().getDimension(designedWidthResId);
    ...
    public static boolean setHeight(View view, int designedHeightResId) {
        if (view == null)
            return false;
        float designedHeight = BaseApp.getAppContext().getResources().getDimension(designedHeightResId);
        LayoutParams params = null;
        if (view instanceof ViewGroup)
            params = view.getLayoutParams();
        if (params == null)
    ...
    public static boolean setTextSize(TextView view, int designedTextSizeResId) {
        if (view == null)
            return false;
        float designedSize = BaseApp.getAppContext().getResources().getDimension(designedTextSizeResId);
    ...
    public static float getHorizontalScaledDimen(int heightResId) {
        return BaseApp.getAppContext().getResources().getDimension(heightResId) * SCALE_RATIO_HORIZONTAL;
    }
    ...
    public static float getVerticalScaledDimen(int heightResId) {
        return BaseApp.getAppContext().getResources().getDimension(heightResId) * SCALE_RATIO_VERTICAL;
    }
    ...
    public static int dip2px(float dip) {
        float f = BaseApp.getAppContext().getResources().getDisplayMetrics().density;
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = BaseApp.getAppContext().getResources().getDimensionPixelSize(x);
