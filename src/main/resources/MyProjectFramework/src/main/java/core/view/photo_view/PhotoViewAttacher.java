 ...
 *******************************************************************************/
package $Package.core.view.photo_view;
...
import $Package.core.view.photo_view.gestures.GestureDetector;
import $Package.core.view.photo_view.gestures.OnGestureListener;
import $Package.core.view.photo_view.gestures.VersionedGestureDetector;
import $Package.core.view.photo_view.scrollerproxy.ScrollerProxy;
...
//                        LogManager.getLogger().i(LOG_TAG, "onTouch getParent() returned null");
    ...
    public void setScale(float scale, boolean animate) {
        ...
        if (null != imageView) {
            setScale(scale,
                    (imageView.getRight()) / (float) 2,
                    (imageView.getBottom()) / (float) 2,
                    animate);
        }
    }
